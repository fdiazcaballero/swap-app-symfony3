 ...
 */
class Version20160206150553 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__swap_preference AS SELECT id, product_id, category_preference, subcategory_preference, subsubcategory_preference, is_email_alert, description, geographic_preference FROM swap_preference');
        $this->addSql('DROP TABLE swap_preference');
        $this->addSql('CREATE TABLE swap_preference (id INTEGER NOT NULL, product_id INTEGER NOT NULL, category_preference INTEGER DEFAULT NULL, subcategory_preference INTEGER DEFAULT NULL, subsubcategory_preference INTEGER DEFAULT NULL, subsubsubcategory_preference INTEGER DEFAULT NULL, is_email_alert BOOLEAN DEFAULT \'0\' NOT NULL, description CLOB DEFAULT NULL COLLATE BINARY, geographic_preference TEXT CHECK(geographic_preference IN (\'CNTRY\', \'ST\', \'MA\', \'C\')) DEFAULT \'ST\' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_EDDAD95F4584665A FOREIGN KEY (product_id) REFERENCES product (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EDDAD95F7B77E02D FOREIGN KEY (category_preference) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EDDAD95F9B2CB5D6 FOREIGN KEY (subcategory_preference) REFERENCES subcategory (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EDDAD95F19C8086A FOREIGN KEY (subsubcategory_preference) REFERENCES subsubcategory (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EDDAD95F2380F908 FOREIGN KEY (subsubsubcategory_preference) REFERENCES subsubsubcategory (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO swap_preference (id, product_id, category_preference, subcategory_preference, subsubcategory_preference, is_email_alert, description, geographic_preference) SELECT id, product_id, category_preference, subcategory_preference, subsubcategory_preference, is_email_alert, description, geographic_preference FROM __temp__swap_preference');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE swap_preference');
        $this->addSql('CREATE TABLE swap_preference (id INTEGER NOT NULL, product_id INTEGER NOT NULL, category_preference INTEGER NOT NULL, subcategory_preference INTEGER DEFAULT NULL, subsubcategory_preference INTEGER DEFAULT NULL, description CLOB DEFAULT NULL, is_email_alert BOOLEAN DEFAULT \'0\' NOT NULL, geographic_preference CLOB DEFAULT \'ST\' NOT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_EDDAD95F4584665A FOREIGN KEY (product_id) REFERENCES product (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EDDAD95F7B77E02D FOREIGN KEY (category_preference) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EDDAD95F9B2CB5D6 FOREIGN KEY (subcategory_preference) REFERENCES subcategory (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EDDAD95F19C8086A FOREIGN KEY (subsubcategory_preference) REFERENCES subsubcategory (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO swap_preference (id, product_id, category_preference, subcategory_preference, subsubcategory_preference, description, geographic_preference, is_email_alert) SELECT id, product_id, category_preference, subcategory_preference, subsubcategory_preference, description, geographic_preference, is_email_alert FROM __temp__swap_preference');
        $this->addSql('DROP TABLE __temp__swap_preference');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_EDDAD95F4584665A ON swap_preference (product_id)');
        $this->addSql('CREATE INDEX IDX_EDDAD95F7B77E02D ON swap_preference (category_preference)');
        $this->addSql('CREATE INDEX IDX_EDDAD95F9B2CB5D6 ON swap_preference (subcategory_preference)');
