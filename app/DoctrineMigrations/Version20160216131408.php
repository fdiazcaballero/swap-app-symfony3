 ...
 */
class Version20160216131408 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product AS SELECT id, user_id, swap_preference_id, description, created_at, has_photo, name, condition, years, months FROM product');
        $this->addSql('DROP TABLE product');
        $this->addSql('CREATE TABLE product (id INTEGER NOT NULL, user_id INTEGER NOT NULL, swap_preference_id INTEGER DEFAULT NULL, product_taxonomy_id INTEGER NOT NULL, description CLOB NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, has_photo BOOLEAN DEFAULT \'0\' NOT NULL, name VARCHAR(63) NOT NULL COLLATE BINARY, condition VARCHAR(63) NOT NULL COLLATE BINARY, years SMALLINT DEFAULT NULL, months SMALLINT DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_D34A04ADA76ED395 FOREIGN KEY (user_id) REFERENCES fos_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D34A04AD375DE9CC FOREIGN KEY (swap_preference_id) REFERENCES swap_preference (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D34A04AD397878E9 FOREIGN KEY (product_taxonomy_id) REFERENCES product_taxonomy (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO product (id, user_id, swap_preference_id, description, created_at, has_photo, name, condition, years, months) SELECT id, user_id, swap_preference_id, description, created_at, has_photo, name, condition, years, months FROM __temp__product');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE product');
        $this->addSql('CREATE TABLE product (id INTEGER NOT NULL, user_id INTEGER NOT NULL, swap_preference_id INTEGER DEFAULT NULL, category_id INTEGER NOT NULL, name VARCHAR(63) NOT NULL, description CLOB NOT NULL, condition VARCHAR(63) NOT NULL, years SMALLINT DEFAULT NULL, months SMALLINT DEFAULT NULL, created_at DATETIME NOT NULL, has_photo BOOLEAN DEFAULT \'0\' NOT NULL, subcategory_id INTEGER NOT NULL, subsubcategory_id INTEGER DEFAULT NULL, subsubsubcategory_id INTEGER DEFAULT NULL, furthersubcategory_id INTEGER DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_D34A04ADA76ED395 FOREIGN KEY (user_id) REFERENCES fos_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D34A04AD375DE9CC FOREIGN KEY (swap_preference_id) REFERENCES swap_preference (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D34A04AD397878E9 FOREIGN KEY (category_id) REFERENCES product_taxonomy (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO product (id, user_id, swap_preference_id, category_id, name, description, condition, years, months, created_at, has_photo) SELECT id, user_id, swap_preference_id, product_taxonomy_id, name, description, condition, years, months, created_at, has_photo FROM __temp__product');
        $this->addSql('DROP TABLE __temp__product');
        $this->addSql('CREATE INDEX IDX_D34A04ADA76ED395 ON product (user_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D34A04AD375DE9CC ON product (swap_preference_id)');
