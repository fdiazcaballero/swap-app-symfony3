 ...
 */
class Version20160217105558 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product AS SELECT id, user_id, swap_preference_id, product_taxonomy_id, description, created_at, has_photo, name, condition, years, months FROM product');
        ...
        $this->addSql('INSERT INTO product (id, user_id, swap_preference_id, product_taxonomy_id, description, created_at, has_photo, name, condition, years, months) SELECT id, user_id, swap_preference_id, product_taxonomy_id, description, created_at, has_photo, name, condition, years, months FROM __temp__product');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product_taxonomy AS SELECT id, category_id, subcategory_id, subsubcategory_id, subsubsubcategory_id, furthersubcategory_id FROM product_taxonomy');
        $this->addSql('DROP TABLE product_taxonomy');
        $this->addSql('CREATE TABLE product_taxonomy (id INTEGER NOT NULL, category_id INTEGER NOT NULL, subcategory_id INTEGER NOT NULL, subsubcategory_id INTEGER DEFAULT NULL, subsubsubcategory_id INTEGER DEFAULT NULL, furthersubcategory_id INTEGER DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_36A2D2AA12469DE2 FOREIGN KEY (category_id) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_36A2D2AA5DC6FE57 FOREIGN KEY (subcategory_id) REFERENCES subcategory (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_36A2D2AA3D3B79A7 FOREIGN KEY (subsubcategory_id) REFERENCES subsubcategory (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_36A2D2AA3F318A3A FOREIGN KEY (subsubsubcategory_id) REFERENCES subsubsubcategory (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_36A2D2AAAA86366 FOREIGN KEY (furthersubcategory_id) REFERENCES furthersubcategory (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO product_taxonomy (id, category_id, subcategory_id, subsubcategory_id, subsubsubcategory_id, furthersubcategory_id) SELECT id, category_id, subcategory_id, subsubcategory_id, subsubsubcategory_id, furthersubcategory_id FROM __temp__product_taxonomy');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product AS SELECT id, user_id, swap_preference_id, product_taxonomy_id, name, description, condition, years, months, created_at, has_photo FROM product');
        $this->addSql('DROP TABLE product');
        $this->addSql('CREATE TABLE product (id INTEGER NOT NULL, user_id INTEGER NOT NULL, swap_preference_id INTEGER DEFAULT NULL, product_taxonomy_id INTEGER NOT NULL, name VARCHAR(63) NOT NULL, description CLOB NOT NULL, condition VARCHAR(63) NOT NULL, years SMALLINT DEFAULT NULL, months SMALLINT DEFAULT NULL, created_at DATETIME NOT NULL, has_photo BOOLEAN DEFAULT \'0\' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_D34A04ADA76ED395 FOREIGN KEY (user_id) REFERENCES fos_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D34A04AD375DE9CC FOREIGN KEY (swap_preference_id) REFERENCES swap_preference (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D34A04AD397878E9 FOREIGN KEY (product_taxonomy_id) REFERENCES product_taxonomy (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO product (id, user_id, swap_preference_id, product_taxonomy_id, name, description, condition, years, months, created_at, has_photo) SELECT id, user_id, swap_preference_id, product_taxonomy_id, name, description, condition, years, months, created_at, has_photo FROM __temp__product');
        $this->addSql('DROP TABLE __temp__product');
        $this->addSql('CREATE INDEX IDX_D34A04ADA76ED395 ON product (user_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D34A04AD375DE9CC ON product (swap_preference_id)');
        $this->addSql('CREATE INDEX IDX_D34A04AD397878E9 ON product (product_taxonomy_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product_taxonomy AS SELECT id, category_id, subcategory_id, subsubcategory_id, subsubsubcategory_id, furthersubcategory_id FROM product_taxonomy');
        $this->addSql('DROP TABLE product_taxonomy');
        $this->addSql('CREATE TABLE product_taxonomy (id INTEGER NOT NULL, category_id INTEGER NOT NULL, subcategory_id INTEGER NOT NULL, subsubcategory_id INTEGER DEFAULT NULL, subsubsubcategory_id INTEGER DEFAULT NULL, furthersubcategory_id INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO product_taxonomy (id, category_id, subcategory_id, subsubcategory_id, subsubsubcategory_id, furthersubcategory_id) SELECT id, category_id, subcategory_id, subsubcategory_id, subsubsubcategory_id, furthersubcategory_id FROM __temp__product_taxonomy');
        $this->addSql('DROP TABLE __temp__product_taxonomy');
        $this->addSql('CREATE INDEX IDX_36A2D2AA12469DE2 ON product_taxonomy (category_id)');
        $this->addSql('CREATE INDEX IDX_36A2D2AA5DC6FE57 ON product_taxonomy (subcategory_id)');
