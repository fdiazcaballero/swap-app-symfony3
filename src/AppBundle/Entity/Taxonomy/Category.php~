 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Taxonomy\CategoryRepository")
 */
class Category
{
    /**
     ...
     * @ORM\OneToMany(targetEntity="\AppBundle\Entity\Product\SwapPreference", mappedBy="categoryPreference")
     */
