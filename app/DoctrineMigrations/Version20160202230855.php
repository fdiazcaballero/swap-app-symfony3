 ...
 */
class Version20160202230855 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE country ADD COLUMN is_active BOOLEAN DEFAULT \'0\' NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE country (id INTEGER NOT NULL, name VARCHAR(63) NOT NULL, country_code VARCHAR(3) NOT NULL, PRIMARY KEY(id))');
