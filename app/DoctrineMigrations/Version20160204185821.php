 ...
 */
class Version20160204185821 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__swap_preference AS SELECT id, product_id, category_preference_1, category_preference_2, is_email_alert, geographic_preference FROM swap_preference');
        ...
        $this->addSql('INSERT INTO swap_preference (id, product_id, category_preference_1, category_preference_2, is_email_alert, geographic_preference) SELECT id, product_id, category_preference_1, category_preference_2, is_email_alert, geographic_preference FROM __temp__swap_preference');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__category AS SELECT id, name, swap_preference_1, swap_preference_2 FROM category');
        $this->addSql('DROP TABLE category');
        $this->addSql('CREATE TABLE category (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, swap_preference_1 VARCHAR(255) DEFAULT NULL, swap_preference_2 VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO category (id, name, swap_preference_1, swap_preference_2) SELECT id, name, swap_preference_1, swap_preference_2 FROM __temp__category');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__swap_preference AS SELECT id, product_id, category_preference_1, category_preference_2, geographic_preference, is_email_alert FROM swap_preference');
        $this->addSql('DROP TABLE swap_preference');
        $this->addSql('CREATE TABLE swap_preference (id INTEGER NOT NULL, product_id INTEGER DEFAULT NULL, category_preference_1 INTEGER NOT NULL, category_preference_2 INTEGER DEFAULT NULL, is_email_alert BOOLEAN DEFAULT \'0\' NOT NULL, geographic_preference CLOB DEFAULT \'ST\' NOT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_EDDAD95F4584665A FOREIGN KEY (product_id) REFERENCES product (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EDDAD95FAD0490BE FOREIGN KEY (category_preference_1) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EDDAD95F340DC104 FOREIGN KEY (category_preference_2) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO swap_preference (id, product_id, category_preference_1, category_preference_2, geographic_preference, is_email_alert) SELECT id, product_id, category_preference_1, category_preference_2, geographic_preference, is_email_alert FROM __temp__swap_preference');
        $this->addSql('DROP TABLE __temp__swap_preference');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_EDDAD95F4584665A ON swap_preference (product_id)');
        $this->addSql('CREATE INDEX IDX_EDDAD95FAD0490BE ON swap_preference (category_preference_1)');
        $this->addSql('CREATE INDEX IDX_EDDAD95F340DC104 ON swap_preference (category_preference_2)');
