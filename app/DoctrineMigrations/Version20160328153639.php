 ...
 */
class Version20160328153639 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product AS SELECT id, user_id, swap_preference_id, product_taxonomy_id, product_location_id, product_condition_id, description, created_at, name, years, months, has_photo, image_name, updated_at FROM product');
        $this->addSql('DROP TABLE product');
        $this->addSql('CREATE TABLE product (id INTEGER NOT NULL, user_id INTEGER NOT NULL, swap_preference_id INTEGER DEFAULT NULL, product_taxonomy_id INTEGER NOT NULL, product_location_id INTEGER NOT NULL, product_condition_id INTEGER NOT NULL, description CLOB NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, name VARCHAR(63) NOT NULL COLLATE BINARY, years SMALLINT DEFAULT NULL, months SMALLINT DEFAULT NULL, has_photo BOOLEAN DEFAULT \'0\', image_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_D34A04ADA76ED395 FOREIGN KEY (user_id) REFERENCES fos_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D34A04AD375DE9CC FOREIGN KEY (swap_preference_id) REFERENCES swap_preference (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D34A04AD397878E9 FOREIGN KEY (product_taxonomy_id) REFERENCES product_taxonomy (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D34A04ADAA62BF91 FOREIGN KEY (product_location_id) REFERENCES product_location (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D34A04AD5D3B1DD FOREIGN KEY (product_condition_id) REFERENCES product_condition (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO product (id, user_id, swap_preference_id, product_taxonomy_id, product_location_id, product_condition_id, description, created_at, name, years, months, has_photo, image_name, updated_at) SELECT id, user_id, swap_preference_id, product_taxonomy_id, product_location_id, product_condition_id, description, created_at, name, years, months, has_photo, image_name, updated_at FROM __temp__product');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_D34A04ADAA62BF91');
        $this->addSql('DROP INDEX IDX_D34A04AD5D3B1DD');
        $this->addSql('CREATE TEMPORARY TABLE __temp__product AS SELECT id, user_id, swap_preference_id, product_taxonomy_id, product_location_id, product_condition_id, name, description, years, months, created_at, has_photo, image_name, updated_at FROM product');
        $this->addSql('DROP TABLE product');
        $this->addSql('CREATE TABLE product (id INTEGER NOT NULL, user_id INTEGER NOT NULL, swap_preference_id INTEGER DEFAULT NULL, product_location_id INTEGER NOT NULL, product_condition_id INTEGER NOT NULL, name VARCHAR(63) NOT NULL, description CLOB NOT NULL, years SMALLINT DEFAULT NULL, months SMALLINT DEFAULT NULL, created_at DATETIME NOT NULL, has_photo BOOLEAN DEFAULT \'0\', image_name VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, product_taxonomy_id INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO product (id, user_id, swap_preference_id, product_taxonomy_id, product_location_id, product_condition_id, name, description, years, months, created_at, has_photo, image_name, updated_at) SELECT id, user_id, swap_preference_id, product_taxonomy_id, product_location_id, product_condition_id, name, description, years, months, created_at, has_photo, image_name, updated_at FROM __temp__product');
        $this->addSql('DROP TABLE __temp__product');
        $this->addSql('CREATE INDEX IDX_D34A04ADA76ED395 ON product (user_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D34A04AD375DE9CC ON product (swap_preference_id)');
        $this->addSql('CREATE INDEX IDX_D34A04AD397878E9 ON product (product_taxonomy_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product_location AS SELECT id, country_id, state_id, city_id FROM product_location');
        $this->addSql('DROP TABLE product_location');
        $this->addSql('CREATE TABLE product_location (id INTEGER NOT NULL, country_id INTEGER NOT NULL, state_id INTEGER DEFAULT NULL, city_id INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO product_location (id, country_id, state_id, city_id) SELECT id, country_id, state_id, city_id FROM __temp__product_location');
        $this->addSql('DROP TABLE __temp__product_location');
        $this->addSql('CREATE INDEX IDX_952EE35CF92F3E70 ON product_location (country_id)');
        $this->addSql('CREATE INDEX IDX_952EE35C5D83CC1 ON product_location (state_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product_taxonomy AS SELECT id, category_id, sub_category_id, subsubcategory_id, subsubsub_category_id, further_sub_category_id, further_sub_category2_id FROM product_taxonomy');
        $this->addSql('DROP TABLE product_taxonomy');
        $this->addSql('CREATE TABLE product_taxonomy (id INTEGER NOT NULL, category_id INTEGER NOT NULL, sub_category_id INTEGER DEFAULT NULL, subsubcategory_id INTEGER DEFAULT NULL, subsubsub_category_id INTEGER DEFAULT NULL, further_sub_category_id INTEGER DEFAULT NULL, further_sub_category2_id INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO product_taxonomy (id, category_id, sub_category_id, subsubcategory_id, subsubsub_category_id, further_sub_category_id, further_sub_category2_id) SELECT id, category_id, sub_category_id, subsubcategory_id, subsubsub_category_id, further_sub_category_id, further_sub_category2_id FROM __temp__product_taxonomy');
        $this->addSql('DROP TABLE __temp__product_taxonomy');
        $this->addSql('CREATE INDEX IDX_36A2D2AA12469DE2 ON product_taxonomy (category_id)');
        $this->addSql('CREATE INDEX IDX_36A2D2AAF7BFE87C ON product_taxonomy (sub_category_id)');
