 ...
 */
class Version20160217115547 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE further_subcategory2 (id INTEGER NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('DROP INDEX IDX_36A2D2AA5DC6FE57');
        $this->addSql('DROP INDEX IDX_36A2D2AA3D3B79A7');
        $this->addSql('DROP INDEX IDX_36A2D2AA3F318A3A');
        $this->addSql('DROP INDEX IDX_36A2D2AAAA86366');
        $this->addSql('CREATE TEMPORARY TABLE __temp__product_taxonomy AS SELECT id, category_id, subcategory_id, subsubcategory_id FROM product_taxonomy');
        ...
        $this->addSql('INSERT INTO product_taxonomy (id, category_id, sub_category_id, subsubcategory_id) SELECT id, category_id, subcategory_id, subsubcategory_id FROM __temp__product_taxonomy');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__swap_preference AS SELECT id, product_id, category_preference, subsubcategory_preference, furthersubcategory_preference, is_email_alert, description, is_free, is_willing_to_deliver, geographic_preference FROM swap_preference');
        ...
        $this->addSql('INSERT INTO swap_preference (id, product_id, category_preference, subsubcategory_preference, furthersubcategory_preference, is_email_alert, description, is_free, is_willing_to_deliver, geographic_preference) SELECT id, product_id, category_preference, subsubcategory_preference, furthersubcategory_preference, is_email_alert, description, is_free, is_willing_to_deliver, geographic_preference FROM __temp__swap_preference');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE furthersubcategory (id INTEGER NOT NULL, parent_subsubsubcategory_id INTEGER NOT NULL, name VARCHAR(63) NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, swap_preference VARCHAR(255) DEFAULT NULL COLLATE BINARY, is_active BOOLEAN DEFAULT \'1\' NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE subcategory (id INTEGER NOT NULL, parent_category_id INTEGER NOT NULL, name VARCHAR(63) NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, swap_preference VARCHAR(255) DEFAULT NULL COLLATE BINARY, is_active BOOLEAN DEFAULT \'1\' NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE subsubcategory (id INTEGER NOT NULL, parent_subcategory_id INTEGER NOT NULL, name VARCHAR(63) NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, swap_preference VARCHAR(255) DEFAULT NULL COLLATE BINARY, is_active BOOLEAN DEFAULT \'1\' NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE subsubsubcategory (id INTEGER NOT NULL, parent_subsubcategory_id INTEGER NOT NULL, name VARCHAR(63) NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, swap_preference VARCHAR(255) DEFAULT NULL COLLATE BINARY, is_active BOOLEAN DEFAULT \'1\' NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product_taxonomy AS SELECT id, category_id, sub_category_id, subsubcategory_id FROM product_taxonomy');
        $this->addSql('DROP TABLE product_taxonomy');
        $this->addSql('CREATE TABLE product_taxonomy (id INTEGER NOT NULL, category_id INTEGER NOT NULL, subcategory_id INTEGER NOT NULL, subsubcategory_id INTEGER DEFAULT NULL, subsubsubcategory_id INTEGER DEFAULT NULL, furthersubcategory_id INTEGER DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_36A2D2AA12469DE2 FOREIGN KEY (category_id) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_36A2D2AAF7BFE87C FOREIGN KEY (subcategory_id) REFERENCES sub_category (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_36A2D2AA3D3B79A7 FOREIGN KEY (subsubcategory_id) REFERENCES subsub_category (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO product_taxonomy (id, category_id, subcategory_id, subsubcategory_id) SELECT id, category_id, sub_category_id, subsubcategory_id FROM __temp__product_taxonomy');
        $this->addSql('DROP TABLE __temp__product_taxonomy');
        $this->addSql('CREATE INDEX IDX_36A2D2AA12469DE2 ON product_taxonomy (category_id)');
        $this->addSql('CREATE INDEX IDX_36A2D2AA3D3B79A7 ON product_taxonomy (subsubcategory_id)');
        $this->addSql('CREATE INDEX IDX_36A2D2AA5DC6FE57 ON product_taxonomy (subcategory_id)');
        $this->addSql('CREATE INDEX IDX_36A2D2AA3F318A3A ON product_taxonomy (subsubsubcategory_id)');
        $this->addSql('CREATE INDEX IDX_36A2D2AAAA86366 ON product_taxonomy (furthersubcategory_id)');
        $this->addSql('DROP INDEX IDX_A393D2FBF92F3E70');
        $this->addSql('CREATE TEMPORARY TABLE __temp__state AS SELECT id, country_id, name, state_code, is_active FROM state');
        $this->addSql('DROP TABLE state');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__swap_preference AS SELECT id, product_id, category_preference, subsubcategory_preference, description, is_free, is_willing_to_deliver, geographic_preference, is_email_alert, FurtherSubCategory_preference FROM swap_preference');
        $this->addSql('DROP TABLE swap_preference');
        $this->addSql('CREATE TABLE swap_preference (id INTEGER NOT NULL, product_id INTEGER NOT NULL, category_preference INTEGER DEFAULT NULL, subsubcategory_preference INTEGER DEFAULT NULL, description CLOB DEFAULT NULL, is_free BOOLEAN DEFAULT \'0\' NOT NULL, is_willing_to_deliver BOOLEAN DEFAULT \'0\' NOT NULL, is_email_alert BOOLEAN DEFAULT \'0\' NOT NULL, FurtherSubCategory_preference INTEGER DEFAULT NULL, geographic_preference CLOB DEFAULT \'ST\' NOT NULL COLLATE BINARY, subcategory_preference INTEGER DEFAULT NULL, subsubsubcategory_preference INTEGER DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_EDDAD95F4584665A FOREIGN KEY (product_id) REFERENCES product (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EDDAD95F7B77E02D FOREIGN KEY (category_preference) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EDDAD95F19C8086A FOREIGN KEY (subsubcategory_preference) REFERENCES subsub_category (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EDDAD95F9C6274A4 FOREIGN KEY (FurtherSubCategory_preference) REFERENCES further_subcategory (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO swap_preference (id, product_id, category_preference, subsubcategory_preference, description, is_free, is_willing_to_deliver, geographic_preference, is_email_alert, FurtherSubCategory_preference) SELECT id, product_id, category_preference, subsubcategory_preference, description, is_free, is_willing_to_deliver, geographic_preference, is_email_alert, FurtherSubCategory_preference FROM __temp__swap_preference');
        $this->addSql('DROP TABLE __temp__swap_preference');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_EDDAD95F4584665A ON swap_preference (product_id)');
        $this->addSql('CREATE INDEX IDX_EDDAD95F7B77E02D ON swap_preference (category_preference)');
        $this->addSql('CREATE INDEX IDX_EDDAD95F19C8086A ON swap_preference (subsubcategory_preference)');
