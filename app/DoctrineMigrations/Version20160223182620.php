 ...
 */
class Version20160223182620 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE product');
        $this->addSql('CREATE TABLE product (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, product_condition_id INTEGER NOT NULL, name VARCHAR(63) NOT NULL, description CLOB NOT NULL, years SMALLINT DEFAULT NULL, months SMALLINT DEFAULT NULL, created_at DATETIME NOT NULL, has_photo BOOLEAN DEFAULT \'0\' NOT NULL, swap_preference_id INTEGER NOT NULL, product_taxonomy_id INTEGER NOT NULL, product_location_id INTEGER NOT NULL, PRIMARY KEY(id))');
