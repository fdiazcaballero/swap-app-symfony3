 ...
 */
class Version20160202175744 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE country (id INTEGER NOT NULL, name VARCHAR(63) NOT NULL, country_code VARCHAR(3) NOT NULL, country_code_alpha3 VARCHAR(3) NOT NULL, longitude DOUBLE PRECISION NOT NULL, latitude DOUBLE PRECISION NOT NULL, phone_prefix SMALLINT NOT NULL, PRIMARY KEY(id))');
