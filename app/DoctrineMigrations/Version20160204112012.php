 ...
 */
class Version20160204112012 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__city AS SELECT id, name, country_id FROM city');
        ...
        $this->addSql('INSERT INTO city (id, name, country_id) SELECT id, name, country_id FROM __temp__city');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE city');
        $this->addSql('CREATE TABLE city (id INTEGER NOT NULL, country_id INTEGER DEFAULT NULL, name VARCHAR(63) NOT NULL, PRIMARY KEY(id))');
