 ...
 */
class Version20160217172211 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__further_subcategory2 AS SELECT id FROM further_subcategory2');
        $this->addSql('DROP TABLE further_subcategory2');
        $this->addSql('CREATE TABLE further_subcategory2 (id INTEGER NOT NULL, parent_further_sub_category_id INTEGER NOT NULL, name VARCHAR(63) NOT NULL, description CLOB DEFAULT NULL, is_active BOOLEAN DEFAULT \'1\' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_3EACDDD69B00B06C FOREIGN KEY (parent_further_sub_category_id) REFERENCES further_subcategory (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO further_subcategory2 (id) SELECT id FROM __temp__further_subcategory2');
