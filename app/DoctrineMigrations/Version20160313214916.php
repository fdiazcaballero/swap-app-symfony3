 ...
 */
class Version20160313214916 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_D34A04ADAA62BF91');
        $this->addSql('DROP INDEX IDX_D34A04AD5D3B1DD');
        $this->addSql('CREATE TEMPORARY TABLE __temp__product AS SELECT id, user_id, swap_preference_id, product_taxonomy_id, product_location_id, product_condition_id, name, description, years, months, created_at, has_photo, image_name FROM product');
        $this->addSql('DROP TABLE product');
        $this->addSql('CREATE TABLE product (id INTEGER NOT NULL, user_id INTEGER NOT NULL, swap_preference_id INTEGER DEFAULT NULL, product_taxonomy_id INTEGER DEFAULT NULL, product_location_id INTEGER NOT NULL, product_condition_id INTEGER NOT NULL, name VARCHAR(63) NOT NULL, description CLOB NOT NULL, years SMALLINT DEFAULT NULL, months SMALLINT DEFAULT NULL, created_at DATETIME NOT NULL, has_photo BOOLEAN DEFAULT \'0\', picture VARCHAR(255) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO product (id, user_id, swap_preference_id, product_taxonomy_id, product_location_id, product_condition_id, name, description, years, months, created_at, has_photo, picture) SELECT id, user_id, swap_preference_id, product_taxonomy_id, product_location_id, product_condition_id, name, description, years, months, created_at, has_photo, image_name FROM __temp__product');
        $this->addSql('DROP TABLE __temp__product');
        $this->addSql('CREATE INDEX IDX_D34A04ADA76ED395 ON product (user_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D34A04AD375DE9CC ON product (swap_preference_id)');
        $this->addSql('CREATE INDEX IDX_D34A04AD397878E9 ON product (product_taxonomy_id)');
